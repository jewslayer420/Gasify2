...
const GROUPS = [
  ...
  },
  {
    ...
    sources: [
      ...
      { region: 'Vietnam', name: 'MOIT/MOF joint retail price decisions', licence: 'Official published price' },
      { region: 'Egypt', name: 'Ministry of Petroleum fuel pricing committee', licence: 'Official published price' },
      ...
      { region: 'Moldova', name: 'ANRE — daily maximum prices', licence: 'Official published price', url: 'https://anre.md' },
      { region: 'Israel', name: 'Ministry of Energy — regulated 95 octane price', licence: 'Official published price' },
      { region: 'Pakistan', name: 'OGRA-notified prices (fortnightly)', licence: 'Official published price', url: 'https://www.ogra.org.pk' },
      { region: 'Japan', name: 'METI weekly national average (official statistic)', licence: 'Government statistic' },
      { region: 'Bangladesh', name: 'BPC automatic pricing mechanism', licence: 'Official published price' },
      { region: 'Sri Lanka', name: 'Ceylon Petroleum Corporation (monthly)', licence: 'Official published price', url: 'https://ceypetco.gov.lk' },
      { region: 'Nepal', name: 'Nepal Oil Corporation (Kathmandu reference)', licence: 'Official published price', url: 'https://noc.org.np' },
      { region: 'Costa Rica', name: 'ARESEP regulated prices (uniform nationwide)', licence: 'Official published price', url: 'https://aresep.go.cr' },
      { region: 'Panama', name: 'Secretaría Nacional de Energía (biweekly)', licence: 'Official published price' },
      { region: 'Azerbaijan', name: 'Tariff Council fixed prices', licence: 'Official published price' },
      { region: 'Algeria', name: 'ARH state-fixed prices', licence: 'Official published price' },
