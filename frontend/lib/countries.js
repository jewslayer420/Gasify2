...
export const COUNTRY_NAMES = {
  ...
  IS: 'Iceland', MX: 'Mexico', TW: 'Taiwan', LI: 'Liechtenstein', AD: 'Andorra',
  MC: 'Monaco', CY: 'Cyprus', MT: 'Malta',
  MY: 'Malaysia', TH: 'Thailand', NZ: 'New Zealand', CA: 'Canada',
  CL: 'Chile', BR: 'Brazil', US: 'United States', ZA: 'South Africa',
  AE: 'UAE', SA: 'Saudi Arabia', KE: 'Kenya', DO: 'Dominican Rep.', UY: 'Uruguay',
  QA: 'Qatar', KW: 'Kuwait', OM: 'Oman', BH: 'Bahrain', BN: 'Brunei', EC: 'Ecuador',
  VN: 'Vietnam', EG: 'Egypt', JO: 'Jordan', TN: 'Tunisia', MA: 'Morocco',
  ID: 'Indonesia', IN: 'India', MD: 'Moldova', IL: 'Israel', PK: 'Pakistan',
  JP: 'Japan', BD: 'Bangladesh', LK: 'Sri Lanka', NP: 'Nepal', CR: 'Costa Rica',
  PA: 'Panama', AZ: 'Azerbaijan', DZ: 'Algeria',
};
